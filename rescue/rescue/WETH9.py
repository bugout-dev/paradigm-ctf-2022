...
class WETH9:
    def __init__(self, contract_address: Optional[ChecksumAddress]):
        self.contract_name = "WETH9"
        self.address = contract_address
        self.contract = None
        self.abi = get_abi_json("WETH9")
    ...
    def approve(self, arg1: ChecksumAddress, arg2: int, transaction_config) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.approve(arg1, arg2, transaction_config)

    def balance_of(
        self, arg1: ChecksumAddress, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.balanceOf.call(arg1, block_identifier=block_number)

    def deposit(self, transaction_config) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.deposit(transaction_config)

    def transfer(self, arg1: ChecksumAddress, arg2: int, transaction_config) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.transfer(arg1, arg2, transaction_config)
    ...
    def transfer_from(
        ...
        self.assert_contract_is_instantiated()
        return self.contract.transferFrom(arg1, arg2, arg3, transaction_config)
...
def get_transaction_config(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    if args.value is not None:
        transaction_config["value"] = args.value
...
def handle_balance_of(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = WETH9(args.address)
    result = contract.balance_of(arg1=args.arg1, block_number=args.block_number)
    print(result)


def handle_deposit(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = WETH9(args.address)
    transaction_config = get_transaction_config(args)
    result = contract.deposit(transaction_config=transaction_config)
    print(result)
    if args.verbose:
        print(result.info())
...
def generate_cli() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="CLI for WETH9")
    ...
    approve_parser.add_argument("--arg1", required=True, help="Type: address")
    approve_parser.add_argument("--arg2", required=True, help="Type: uint256", type=int)
    ...
    balance_of_parser.add_argument("--arg1", required=True, help="Type: address")
    balance_of_parser.set_defaults(func=handle_balance_of)

    deposit_parser = subcommands.add_parser("deposit")
    add_default_arguments(deposit_parser, True)
    deposit_parser.set_defaults(func=handle_deposit)

    transfer_parser = subcommands.add_parser("transfer")
    add_default_arguments(transfer_parser, True)
    transfer_parser.add_argument("--arg1", required=True, help="Type: address")
    ...
    transfer_from_parser.add_argument("--arg1", required=True, help="Type: address")
    transfer_from_parser.add_argument("--arg2", required=True, help="Type: address")
