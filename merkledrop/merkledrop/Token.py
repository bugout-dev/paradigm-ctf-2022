...
class Token:
    def __init__(self, contract_address: Optional[ChecksumAddress]):
        self.contract_name = "Token"
        self.address = contract_address
        self.contract = None
        self.abi = get_abi_json("Token")
    ...
    def allowance(
        ...
        self.assert_contract_is_instantiated()
        return self.contract.allowance.call(arg1, arg2, block_identifier=block_number)

    def approve(self, to: ChecksumAddress, amount: int, transaction_config) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.approve(to, amount, transaction_config)
...
def generate_cli() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="CLI for Token")
    ...
    allowance_parser.add_argument("--arg1", required=True, help="Type: address")
    allowance_parser.add_argument("--arg2", required=True, help="Type: address")
